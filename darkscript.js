...
window.onload = function() {
    ...
    var attentionMessage = '🔥 Your fish are waiting! 🔥';
    var blinkEvent = null;
...
function addItemToCart(title, price, imageSrc) {
    ...
    var cartRowContents = `
        <tr class="cart-item">
            ...
            <td><input class="quantity" type="number" value="5"></td>
...
function removeCartItem(event) {
    ...
    if (confirm("Are you sure about that? You\'ll be missing out on some great deals!") == true) {
